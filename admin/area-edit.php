					...
					<div class="box-body">
							...
							<div class="col-sm-4">
								...
								$ketqua = $sta->fetchAll(PDO::FETCH_ASSOC);
									...
									foreach($ketqua as $cot){
										...
										$hoten = $cot['full_name'];
								?>
									<option <?php if($id==$nguoidaidien) {echo "selected"; } else{echo "";}  ?> value="<?= $id?>"><?php echo $hoten; ?></option>
								<?php }?>
								</select>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-4" style="padding-top:4px;">
								...
								<input type="hidden"  value="<?php echo $hinhanh; ?>">
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								<button type="submit" class="btn btn-success pull-left" name="form1">Cập nhật vùng sản xuất</button>
							</div>
						</div>
					</div>
				</div>
