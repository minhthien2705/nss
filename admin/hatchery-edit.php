...
if(isset($_POST['form1'])){
    ...
    //Thêm feature nào thì nhớ add vô cái update
        $statement = $pdo->prepare("UPDATE tbl_hatchery SET tengiong=?, magiong=?, hinhanh=?, xuatxu=?, gia=? ,mota=?, huongdansudung=?, vungsanxuat=?  WHERE id=?");
        if($statement->execute(array($_POST['tengiong'],$_POST['magiong'],$_POST['p_featured_photo'],$_POST['xuatxu'],$_POST['gia'],$_POST['mota'],$_POST['huongdansudung'],$_POST['vungsanxuat'],$_REQUEST['id']))){
            echo '<script>
...
<section class="content-header">
	<div class="content-header-left">
		<h1>Chỉnh sửa trại giống</h1>
	</div>
	<div class="content-header-right">
		<a href="supplies.php" class="btn btn-primary btn-sm">Xem tất cả trại giống</a>
	</div>
</section>
				...
				<div class="box box-info">
					<div class="box-body">
						...
						<div class="form-group">
							...
							<div class="col-sm-4">
								<input type="text" name="tengiong" class="form-control" value="<?php echo $tengiong; ?>">
							</div>
						</div>	
						...
						<div class="form-group">
							...
							<div class="col-sm-4">
								<input type="text" name="magiong" class="form-control" value="<?php echo $magiong; ?>">
							</div>
						</div>	
						...
						<div class="form-group">
							<label for="" class="col-sm-3 control-label">Thay đổi hình ảnh <span>*</span></label>
							<div class="col-sm-4" style="padding-top:4px;">
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								<button type="submit" class="btn btn-success pull-left" name="form1">Cập nhật trại giống</button>
							</div>
						</div>
					</div>
				</div>
