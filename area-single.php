			...
			<div class="col-md-12">
				<div class="product">
					<div class="row">
						...
						<div class="col-md-7">
							<div class="p-title"><h2><?php echo $tenvsx; ?></h2></div>
					...
					<div class="row" style="border-top: 1px solid #ccc;margin-top:10px">
						<div class="col-md-12">
							...
							<div class="tab-content">
                                ...
                                <div role="tabpanel" class="tab-pane active" id="return_policy" style="margin-top: -30px;">
                                    <h3>Thời gian nuôi trồng:</h3>
                                    <p>
                                        <?php
                                        if($thoigiannuoitrong == '') {
                                            echo "không có dữ liệu";
                                        } else {
                                            echo $thoigiannuoitrong;
                                        }
                                        ?>
                                    </p>
                                </div>
                                ...
                                <div role="tabpanel" class="tab-pane active" id="description" style="margin-top: -30px;">
									...
									<p>
                                        <?php
                                        if($thuocdoanhnghiep == '') {
                                            echo "Không có doanh nghiệp nào?";
                                        } else {
                                            echo $tendn;
                                        }
                                        ?>
