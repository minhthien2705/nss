...
<head>
	...
	<link rel="stylesheet" href="assets/css/bootstrap-touch-slider1.css">
	...
	if($cur_page == 'dashboard.php') {
		?>
		<title>Bảng điều khiển - <?php echo $meta_title_home; ?></title>
		<meta name="keywords" content="<?php echo $meta_keyword_home; ?>">
		<meta name="description" content="<?php echo $meta_description_home; ?>">
		<?php
	}
	...
	if($cur_page == 'customer-order.php') {
		?>
		<title>Đơn - <?php echo $meta_title_home; ?></title>
		<meta name="keywords" content="<?php echo $meta_keyword_home; ?>">
		<meta name="description" content="<?php echo $meta_description_home; ?>">
		<?php
	}
...
<!-- top bar -->
<div class="top" style="background: #1fc730;">
	<div class="container">
		<div class="row">
...
<div class="header" style="background: #1aa929;">
	<div class="container">
		<div class="row inner">
...
<div class="nav" style="background: #1fc730;">
	<div class="container">
		<div class="row">
			<div class="col-md-12 pl_0 pr_0">
				<div class="menu-container">
					<div class="menu" style="background: #1fc730;">
						<ul>
							<li><a href="index.php">Trang chủ</a></li>
							<li><a href="area.php">Vùng sản xuất</a></li>
							<li><a href="factory.php">Nhà xưởng</a></li>
							<li><a href="supplies.php">Vật tư</a></li>
							<li><a href="hatchery.php">Trại giống</a></li>
