...
$statement->execute(array($vungsanxuat));
$result = $statement->fetchAll(PDO::FETCH_ASSOC);                            
foreach ($result as $row) {
    $tenvung = $row['tenvsx'];
}
...
$statement->execute(array($nhaxuong));
$result = $statement->fetchAll(PDO::FETCH_ASSOC);                            
foreach ($result as $row) {
    $tennx = $row['tennx'];
}
...
$statement->execute(array($traigiong));
$result = $statement->fetchAll(PDO::FETCH_ASSOC);                            
foreach ($result as $row) {
    ...
    if(isset($_SESSION['cart_p_id']))
    {
        ...
        if($added == 1) {
           $error_message1 = 'Sản phẩm này đã được thêm vào giỏ hàng.';
            ...
            $success_message1 = 'Sản phẩm đã được thêm vào giỏ hàng thành công!';
        }
				...
				<div class="product">
					<div class="row">
						...
						<div class="col-md-7">
                            ...
                            <div class="p-title"><h4><?php echo $p_old_price; ?></h4></div>
                            <div class="p-title"><h4><?php echo $gia; ?></h4></div>
                            <div class="p-title"><h4><?php echo $xuatxu; ?></h4></div>
                                ...
                                <div role="tabpanel" class="tab-pane" id="feature" style="margin-top: -30px;">
                                    <p>
                                        ...
                                        if($tenvung == '') {
                                            ...
                                            echo '<div class="p-title"><h2>Vùng sản xuất</h2></div><br>';
                                            echo $tenvung.'<br>';
                                            echo '<a class="btn btn-primary f-right" href="area-single.php?id='. $vungsanxuat.'">Xem chi tiết</a>';
                                        }
                                        ?>
                                    </p>
                                    <hr>
                                    <p>
                                        ...
                                        if($tennx == '') {
                                            ...
                                            echo '<div class="p-title"><h2>Nhà xưởng</h2></div><br>';
                                            echo $tennx.'<br>';
                                            echo '<a class="btn btn-primary f-right" href="factory-single.php?id='. $nhaxuong.'">Xem chi tiết</a>';
                                        }
                                        ?>
                                    </p>
                                    <hr>
                                    <p>
                                        ...
                                        if($tennx == '') {
                                            ...
                                            echo '<div class="p-title"><h2>Vật tư</h2></div><br>';
                                            echo $tenvt.'<br>';
                                            echo '<a class="btn btn-primary f-right" href="supplies-single.php?id='. $vattu.'">Xem chi tiết</a>';
                                        }
                                        ?>
                                    </p>
                                    <hr>
                                    <p>
                                        ...
                                        if($tengiong == '') {
                                            ...
                                            echo '<div class="p-title"><h2>Trại giống</h2></div><br>';
                                            echo $tengiong.'<br>';
                                            echo '<a class="btn btn-primary f-right" href="hatchery-single.php?id='. $traigiong.'">Xem chi tiết</a>';
                                        }
                                        ?>
                                    </p>
                                </div>
                    ...
                    foreach ($result as $row) {
                        ...
                        <div class="item">
                            ...
                            <div class="text">
                                ...
                                <p><a href="product.php?id=<?php echo $row['p_id']; ?>"><?= $row['masanpham'];?></a></p>
                            </div>
                        </div>
                        <?php
                    }
