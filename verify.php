...
if ( (!isset($_REQUEST['email'])) || (isset($_REQUEST['token'])) )
{
    ...
    if($var != 0)
    {
        ...
        $success_message = '<p style="color:green;">Tài khoản của bạn đã được xác thực. Bạn có thể đăng nhập ngay bây giờ.</p><p><a href="'.BASE_URL.'login.php" style="color:#167ac6;font-weight:bold;">Click here to login</a></p>';     
    }
}
?>
